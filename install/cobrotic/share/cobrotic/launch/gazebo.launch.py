...
def generate_launch_description():
    ...
    controllers_file = PathJoinSubstitution([pkg_cobrotic_moveit, "config", "ros2_controllers.yaml"])
    rviz_config_file = PathJoinSubstitution([pkg_cobrotic_moveit, "config", "moveit.rviz"])
    srdf_file = PathJoinSubstitution([pkg_cobrotic_moveit, "config", "cobra.srdf"])
